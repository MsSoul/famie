...
class SettingsWidgetState extends State<SettingsWidget> {
  ...
  Widget build(BuildContext context) {
    // Get app bar color and text styles from the theme
    ...
    final String? fontFamily = Theme.of(context).textTheme.bodyMedium?.fontFamily ?? 'Georgia';
    ...
    return Column(
      children: [
            ...
            Expanded(
              child: Padding(
                ...
                child: SettingsCard(
                  ...
                  iconColor: selectedSetting == 'Time Management' ? Colors.white : appBarColor,
                  textColor: selectedSetting == 'Time Management' ? Colors.white : Colors.black,
                  fontFamily: fontFamily, // Use the theme's font family
                ),
              ),
            ),
            ...
            Expanded(
              child: Padding(
                ...
                child: SettingsCard(
                  ...
                  iconColor: selectedSetting == 'App Management' ? Colors.white : appBarColor,
        ...
        Divider(
          color: appBarColor, // Set the divider color to match the app bar
          height: 2,
        ),
        Expanded(
...
class SettingsCard extends StatelessWidget {
  ...
  final String? fontFamily; // Add font family property
  ...
  const SettingsCard({
    ...
    this.fontFamily, // Add font family
  });
                ...
                children: [
                  ...
                  FittedBox(
                    ...
                    child: Text(
                      title,
                      style: TextStyle(
                        fontFamily: fontFamily, // Use the theme's font style
                        fontSize: 16.0,
                        fontWeight: FontWeight.bold,
