...
import '../design/dialog_prompt.dart'; // Correctly use the dialog prompt import
...
class ChildRegistrationScreenState extends State<ChildRegistrationScreen> {
  ...
  void initState() {
    super.initState();
    // Show the first-time registration dialog
    _showFirstTimeRegisterDialog();
  }
  ...
  // Use the imported function from dialog_prompt.dart
void _showFirstTimeRegisterDialog() {
  DialogPrompt.famkidInfoPrompt(
    context, 
    widget.parentId,  // Pass the parentId from the widget
    (String childName, String childAvatar) {
      // Handle the child registration callback here if needed
    ...
    return Scaffold(
      ...
      body: Column(
        children: [
          ...
          // Add information icon at the right corner
          Align(
            alignment: Alignment.topRight,
            child: IconButton(
              icon: Icon(Icons.info, color: Theme.of(context).appBarTheme.backgroundColor), // Set the icon color to the app bar color
              onPressed: _showFirstTimeRegisterDialog, // Show the dialog prompt
            ),
          ),
          Expanded(
            child: Stack(
